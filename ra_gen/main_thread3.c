...
#include "main_thread3.h"
                ...
                void main_thread3_create(void);
                static void main_thread3_func(void * pvParameters);
                void rtos_startup_err_callback(void * p_instance, void * p_data);
                void rtos_startup_common_init(void);
extern uint32_t g_fsp_common_thread_count;

                const rm_freertos_port_parameters_t main_thread3_parameters =
                {
                    .p_context = (void *) NULL,
                };
                ...
                void main_thread3_create (void)
                {
                    ...
                    #if 1
                    main_thread3 = xTaskCreateStatic(
                    #else
                    BaseType_t main_thread3_create_err = xTaskCreate(
                    #endif
                        main_thread3_func,
                        ...
                        1,
                        #if 1
                        (StackType_t *)&main_thread3_stack,
                        (StaticTask_t *)&main_thread3_memory
                        #else
                        & main_thread3
                        #endif
                    );
                    ...
                    #if 1
                    if (NULL == main_thread3)
                    {
                        rtos_startup_err_callback(main_thread3, 0);
                    }
                    #else
                    if (pdPASS != main_thread3_create_err)
                    {
                        rtos_startup_err_callback(main_thread3, 0);
                    }
                    #endif
                ...
                static void main_thread3_func (void * pvParameters)
                {
                    ...
                    main_thread3_entry(pvParameters);
                }
