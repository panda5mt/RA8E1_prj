...
ceu_instance_ctrl_t g_ceu1_ctrl;
            const ceu_extended_cfg_t g_ceu1_extended_cfg =
            {
            ...
            const capture_cfg_t g_ceu1_cfg =
            {
                ...
                .bytes_per_pixel       = 2,
                .p_callback            = g_ceu1_user_callback,
                .p_context             = NULL,
                .p_extend              = &g_ceu1_extended_cfg,
            };

            const capture_instance_t g_ceu1 =
            {
                .p_ctrl = &g_ceu1_ctrl,
                .p_cfg =  &g_ceu1_cfg,
