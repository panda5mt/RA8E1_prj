...
#endif
        .compare_match_value = {/* CMP_A */ (uint32_t)0x0, /* CMP_B */ (uint32_t)0x0},
...
const timer_cfg_t g_timer2_cfg =
    {
        .mode = TIMER_MODE_PERIODIC,
        /* Actual period: 0.5 seconds. Actual duty: 50%. */ .period_counts = (uint32_t)0x3938700,
        .duty_cycle_counts = 0x1c9c380,
        .source_div = (timer_source_div_t)0,
        .channel = 2,
        .p_callback = NULL,
/** If NULL then do not add & */
