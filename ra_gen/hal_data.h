...
/* CEU on CAPTURE instance */
            extern const capture_instance_t g_ceu1;
            /* Access the CEU instance using these structures when calling API functions directly (::p_api is not used). */
            extern ceu_instance_ctrl_t g_ceu1_ctrl;
            extern const capture_cfg_t g_ceu1_cfg;
            #ifndef g_ceu1_user_callback
            void g_ceu1_user_callback(capture_callback_args_t * p_args);
            #endif
