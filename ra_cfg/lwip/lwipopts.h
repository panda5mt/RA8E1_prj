...
#define TCP_OOSEQ_BYTES_LIMIT(pbc) (TCP_OOSEQ_MAX_BYTES)
#define TCP_OOSEQ_MAX_PBUFS (0)
#define TCP_OOSEQ_PBUFS_LIMIT(pbc) (TCP_OOSEQ_MAX_PBUFS)
...
/*
 * IMPORTANT:
 * FreeRTOS time slicing is disabled in this project (configUSE_TIME_SLICING=0).
 * Keep tcpip_thread at higher priority than application threads so lwIP timers
 * (DHCP/AutoIP/ARP) are not starved by long-running compute or logging loops.
 */
...
#define LWIP_ND6_MAX_ANYCAST_DELAY_TIME (RA_NOT_DEFINED)
#define LWIP_ND6_MAX_NEIGHBOR_ADVERTISEMENT (RA_NOT_DEFINED)
