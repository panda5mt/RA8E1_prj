...
static const cam_reg_value_t ov5642_init_reg_tbl[] = {
    ...
    {0x38, 0x08, 0x01},
    {0x38, 0x09, 0x00}, // H-size:0x0280 = 640, 0x0200 = 512, 0x0100 = 256
    {0x38, 0x0a, 0x01},
    {0x38, 0x0b, 0x00}, // V-size:0x01e0 = 480, 0x0200 = 512, 0x0100 = 256
    {0x38, 0x0e, 0x07},
    ...
    {0x47, 0x40, 0x2d}, // 0x2d -> 0x23 ルネサスCEUはHSYNC/VSYNCにかかわりなくPCLKが出力されていないと動かない模様
